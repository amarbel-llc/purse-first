...
func readFixtureFile(t *testing.T, root, relPath string) string {
	t.Helper()
...
func TestExportGeneratesFacadeCrate(t *testing.T) {
	root := writeFixtureWorkspaceFiles(t)
	...
	libRS := readFixtureFile(t, root, "pkgs/blob_store_id/src/lib.rs")

	wantLibRS := "// Code generated by dagnabit; DO NOT EDIT.\n\n" +
		"pub use blob_store_id_internal::*;\n"
	if libRS != wantLibRS {
		t.Errorf("lib.rs mismatch:\ngot:\n%s\nwant:\n%s", libRS, wantLibRS)
	}

	manifest := readFixtureFile(t, root, "pkgs/blob_store_id/Cargo.toml")
	...
	ws := readFixtureFile(t, root, "Cargo.toml")
...
func TestExportOmitsEditionWhenInternalCrateOmitsIt(t *testing.T) {
	...
	writeFixture(t, root, "internal/0/oldstyle/Cargo.toml", `[package]
name = "oldstyle_internal"
version = "0.1.0"
`)
	writeFixture(t, root, "internal/0/oldstyle/src/lib.rs", "pub fn f() {}\n")
	...
	manifest := readFixtureFile(t, root, "pkgs/oldstyle/Cargo.toml")
...
func TestExportRejectsNamingCollision(t *testing.T) {
	...
	writeFixture(t, root, "internal/0/badcrate/Cargo.toml", `[package]
name = "badcrate"
version = "0.1.0"
edition = "2021"
`)
	writeFixture(t, root, "internal/0/badcrate/src/lib.rs", "pub fn f() {}\n")
...
func TestExportAllExportsEverythingUnderInternal(t *testing.T) {
	...
	storeLibRS := readFixtureFile(t, root, "pkgs/store/src/lib.rs")
...
func TestExportDryRunWritesNothing(t *testing.T) {
	...
	wsBefore := readFixtureFile(t, root, "Cargo.toml")
	...
	if wsAfter := readFixtureFile(t, root, "Cargo.toml"); wsAfter != wsBefore {
